...
export const getTop2MaxNumbers = (numbers) => {
  const newsetfromstackoverflow = Array.from(new Set(numbers));
  const sortNumbers = newsetfromstackoverflow.sort((a, b) => b - a);
  const top2MaxNumbers = sortNumbers.slice(0, 2);
  return top2MaxNumbers;
};
